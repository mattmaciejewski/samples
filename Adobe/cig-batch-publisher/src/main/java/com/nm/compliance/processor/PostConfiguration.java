...
public class PostConfiguration {
	...
	public JdbcCursorItemReader<ThreadData> reader()
	{
		...
		forumReader.setSql("Select distinct MeetingName from dbo.ADOBE_CONNECT_MEETING WHERE PROCESSSTATUSIND=0");
		...
		String threadName = null;
			...
			public ThreadData mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				messageRawData.setThreadName(rs.getString("MeetingName"));
