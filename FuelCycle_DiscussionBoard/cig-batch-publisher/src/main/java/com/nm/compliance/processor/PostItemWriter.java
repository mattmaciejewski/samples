...
public class PostItemWriter implements ItemWriter<ThreadData> {
    ...
    public void write(List<? extends ThreadData> items) throws Exception {
    	...
    	for (ThreadData threadData : items) {
    		FileWriter fileWriter = new FileWriter("//WST-STSQ-000968/D$/Passenger_Discussion/Passenger_Discussion_EML/" + threadData.getThreadName().replace("?", "") + "_" + sdfDate +".eml");
            ...
            fileWriter.write("X-FaceTime-IMA-networkName: PassengerFuelCycle\r\n");
            fileWriter.write("X-FaceTime-IMA-startTime: "+ threadData.getRootPostData().getMetadata().getPostDtm()+"\r\n");
            fileWriter.write("X-ZANTAZ-CONTENT-TYPE: Fuel Cycle\r\n");
            fileWriter.write("X-HearsaySocial-Network: PassengerFuelCycle\r\n");
            fileWriter.write("X-HearsaySocial-ActivityType: Discussions\r\n");
            fileWriter.write("X-HearsaySocial-PreApproved: false\r\n");
            fileWriter.write("X-FaceTime-IMA-parentURL:\r\n");
            fileWriter.write("X-FaceTime-IMA-resourceName: Discussions\r\n");
